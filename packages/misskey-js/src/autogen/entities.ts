...
export type AdminStripeCustomerSubscriptionCreatedRequest = operations['admin___stripe___customer-subscription-created']['requestBody']['content']['application/json'];
export type AdminStripeCustomerSubscriptionDeletedRequest = operations['admin___stripe___customer-subscription-deleted']['requestBody']['content']['application/json'];
export type AdminStripeCustomerSubscriptionPausedRequest = operations['admin___stripe___customer-subscription-paused']['requestBody']['content']['application/json'];
export type AdminStripeCustomerSubscriptionResumedRequest = operations['admin___stripe___customer-subscription-resumed']['requestBody']['content']['application/json'];
export type AdminStripeInvoicePaidRequest = operations['admin___stripe___invoice-paid']['requestBody']['content']['application/json'];
export type AdminStripeInvoicePaymentFailedRequest = operations['admin___stripe___invoice-payment-failed']['requestBody']['content']['application/json'];
